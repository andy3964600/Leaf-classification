...
plot_model(model,show_shapes=True,to_file='leaf_classificationModel4.png')    
...
plt.title('The accuracy of training and validation in Model4')
...
plt.title('Training and validation loss in Model4')
