...
plot_model(model,show_shapes=True,to_file='leaf_classificationModel2.png')    
...
plt.title('The accuracy of training and validation in Model2')
...
plt.title('Training and validation loss in Model2')
