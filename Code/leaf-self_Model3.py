...
plot_model(model,show_shapes=True,to_file='leaf_classificationModel3.png')    
...
plt.title('The accuracy of training and validation in Model3')
...
plt.title('Training and validation loss in Model3')
