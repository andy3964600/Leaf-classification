...
plot_model(model,show_shapes=True,to_file='leaf_classificationModel5.png')    
...
plt.title('The accuracy of training and validation in Model5')
...
plt.title('Training and validation loss in Model5')
